...
public class Gameovercloud : MonoBehaviour
{
    ...
    private void AdjustCloudParticleSizeAndSpread()
    {
        if(cloudParticles != null)
        {
            ...
            //main.startSize = new ParticleSystem.MinMaxCurve(0.5f, 0.5f);
            main.startSize3D = true;
            main.startSizeX = new ParticleSystem.MinMaxCurve(0.5f, 0.8f);  // Horizontal size
            main.startSizeY = new ParticleSystem.MinMaxCurve(0.3f, 0.5f);  // Vertical size (reduce to prevent stretching)
